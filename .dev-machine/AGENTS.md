# ridecast2 -- Autonomous Development Machine
...
```bash
amplifier recipe execute .dev-machine/recipes/dev-machine-build.yaml
```

**To fix build/test errors:**
```bash
amplifier recipe execute .dev-machine/recipes/dev-machine-health-check.yaml
```

**To run a single iteration:**
```bash
amplifier recipe execute .dev-machine/recipes/dev-machine-iteration.yaml
```
...
3. Run the machine: `amplifier recipe execute .dev-machine/recipes/dev-machine-build.yaml`
...
| Recipe | Purpose |
|--------|---------|
| `.dev-machine/recipes/dev-machine-build.yaml` | Full machine loop -- orient, work, verify, repeat |
| `.dev-machine/recipes/dev-machine-iteration.yaml` | Single iteration only |
| `.dev-machine/recipes/dev-machine-health-check.yaml` | Detect and fix build/test errors |
| `.dev-machine/recipes/dev-machine-fix-iteration.yaml` | Single fix cycle |

## What NOT to Do

- Do NOT run `npm run build` or `npm run test` and then fix errors ad hoc
